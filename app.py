    ...
    if page == "Predict":
        ...
        with tab3:
            ...
            **Threshold Optimization sürecimiz**:
            ...
            3. **Precision odaklı yaklaşım**: İmbalanced dataset için precision metriği önceliklendirilerek tahmin performansı iyileştirildi
        ...
        with tabs[3]:
            ...
            **Pratik Uygulamalar**:
            ...
            - Veri odaklı tahmin modellerinin uygulanması
            """)
        ...
        **Not**: Bu proje, gerçek bir banka pazarlama kampanyası veri seti üzerinde geliştirilmiş
        ...
        st.markdown("""
        The analysis presented in Figure 2 clearly illustrates the trade-off between precision and recall as the decision threshold varies. For our specific banking marketing application, we determined that a threshold of 0.5 provides optimal results when prioritizing precision, which is critical for reducing false positive predictions while maintaining acceptable recall.
        ...
        3. **Threshold Optimization Framework**: Data-driven threshold determination with precision emphasis provides more accurate predictions in imbalanced classification contexts.
        ...
        * **Transfer Learning**: Leveraging knowledge from other domains to improve prediction in scenarios with limited data
                ...
                **Optimal Threshold Analysis**:
                ...
                if threshold < 0.5:
                    ...
                    **Analysis**: You've selected the optimal threshold of {optimal_threshold:.2f}.
                    ...
                    with an emphasis on precision to reduce false positives in the imbalanced dataset.
                    """)
            ...
            if st.session_state.live_model is None:
                ...
                **Optimal Threshold**: {model_threshold:.2f}
                ...
                if st.button("Make Prediction"):
                    ...
                    # Show prediction based on the probability
                    if prob >= model_threshold:  # Using optimal threshold
                        st.success("**Result:** This customer is predicted to subscribe to a term deposit")
                    else:
                        st.warning("**Result:** This customer is predicted not to subscribe to a term deposit")
